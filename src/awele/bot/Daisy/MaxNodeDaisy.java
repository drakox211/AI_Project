...
public class MaxNodeDaisy extends MinMaxNodeDaisy {
     ...
     *              alphabeta Le seuil pour la coupe alpha-beta
     */
    MaxNodeDaisy(Board board, int depth, double alpha, double beta) {
    ...
    protected MinMaxNodeDaisy getNextNode(Board board, int depth, double alpha, double beta) {
        return new MinNodeDaisy(board, depth, alpha, beta);
    }
